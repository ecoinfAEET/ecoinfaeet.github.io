...
-   [OpenStreetMap: cartografía libre de acceso, uso y contribución](https://youtu.be/Y_kQV5QO1xY) \ 
{{< video https://youtu.be/Y_kQV5QO1xY >}}

    -   Impartido por: Miguel Sevilla-Callejo

    -   Resumen: OpenStreetMap (OSM) es una proyecto de cartografía colaborativa que recoge información espacial de diversa naturaleza de manera global. Del mismo modo que la Wikipedia recoge artículos enciclopédicos, OSM tiene elementos geográficos que, al igual que la primera, son editados por una amplia comunidad de colaboradores y cuyo contenido es de libre acceso y distribución. Estos datos cartográficos abiertos son susceptibles de usarse como base o fuente de datos en investigación. En torno a este proyecto se ha creado un extenso ecosistema de aplicaciones que se nutren de sus datos y se basan en tecnologías libres como OSMAnd. En la charla se presentará qué es, cómo colaborar y como extraer datos de OpenStreetMap al igual que se mostrarán algunas aplicaciones asociadas y de utilidad para el trabajo sobre el terreno o en el ámbito académico y la investigación.
...
-   [OCCUR Shiny app: La importancia de establecer un flujo de trabajo apropiado para validar registros de presencia de especies](https://youtu.be/ck6rzzSy4kE) \ 
...
-   [Análisis de textos con R: ejemplos útiles para la ecología](https://youtu.be/K94y_zAGLmc) \ 
